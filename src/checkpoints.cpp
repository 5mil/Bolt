...
namespace Checkpoints
{
    ...
    // Paris: synchronized checkpoint (centrally broadcasted)
    ...
    // Paris: get last synchronized checkpoint
    ...
    // Paris: only descendant of current sync-checkpoint is allowed
    ...
    // Paris: reset synchronized checkpoint to last hardened checkpoint
...
// Paris: verify signature of sync-checkpoint message
...
// Paris: process synchronized checkpoint
