 ...
 * The Paris Developers 2011-2013
 */
...
{
    resize(850, 550);
    setWindowTitle(tr("Paris Wallet"));
#ifndef Q_WS_MAC
    setWindowIcon(QIcon(":icons/Paris_icon"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/Paris_tooltip"), tr("&About Paris"), this);
    ...
    toggleHideAction = new QAction(QIcon(":/icons/Paris_tooltip"), tr("Show/Hide &Paris"), this);
    toggleHideAction->setToolTip(tr("Show or hide the Paris window"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        if(clientModel->isTestNet())
        {
            ...
            setWindowIcon(QIcon(":icons/Paris_icon"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/Paris_icon"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(title_testnet);
                trayIcon->setIcon(QIcon(":/icons/Paris_tooltip"));
            }
        }
