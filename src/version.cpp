...
// Copyright (c) 2014 The Paris developers
...
// for both Parisd and Paris(-qt), to make it harder for attackers to
// target servers or GUI users specifically.

// For the current run of Paris releases, the client name should be selected from
