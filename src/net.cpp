...
// Copyright (c) 2011-2015 The Paris developers
...
// testnet dns seed begins with 't', all else are Paris dns seeds.
...
void ThreadDNSAddressSeed2(void* parg)
{
    ...
    if (true /*!fTestNet*/)  // Paris enables dns seeding with testnet too
    {
...
void StartNode(void* parg)
{
    ...
    // Paris: mint proof-of-stake blocks in the background
